...
fp = 'H:\\nystrom_experiment\\'
fn = 'bank_marketing'
fnys = fn + '_nys_fix' if if_fix_nys else fn + ('_reg' if if_dml_reg else '') + '_nys3'
fdml = fn + '_nys_fix' if if_fix_nys else fn + ('_reg' if if_dml_reg else '') + '_dml3'
